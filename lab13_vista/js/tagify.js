                ...
                t.exports = function () {
                        ...
                        customBinding() {
                            ...
                            onFocusBlur(t) {
                                    ...
                                    if (this.trigger("keydown", {event: t}), "mix" == e.mode) {
                                        switch (t.key) {
                                            ...
                                            case"Backspace":
                                                ...
                                                if ("Range" != s.type && h && h.hasAttribute("readonly")) return void w(l(h));
                                                "Delete" == t.key && c && T(s.anchorNode.nextSibling) && this.removeTags(s.anchorNode.nextSibling), clearTimeout(M), M = setTimeout((() => {
                                ...
                                var e, i, s, a, n, o, r, l, d = this.settings, h = this.value.length,
                                    ...
                                    m = window.getSelection().getRangeAt(0), v = [].map.call(p, (t => T(t).value));
                                ...
                                var i = t.closest("." + this.settings.classNames.tag), s = this.getNodeIndex(i),
                                    a = T(i), n = this.input.normalize.call(this, t),
                                ...
                                if (this.state.hasFocus || this.toggleFocusClass(), this.DOM.scope.contains(t)) {
                                    var e, i, s = this.settings, a = t.closest("." + s.classNames.tag), n = T(a),
                                        ...
                                        r = {[s.tagTextProp]: o, __tagId: n.__tagId}, l = n.__originalData,
                                        d = this.editTagChangeDetected(g(n, r)), h = this.validateTag(r);
                                    if (o) if (d) {
                                ...
                                var e, i, s = t.target.closest("." + this.settings.classNames.tag), a = T(s),
                                    n = this.settings;
                                ...
                                t.forEach((t => {
                                    t.addedNodes.forEach((t => {
                                        ...
                                        } else if (v.call(this, t)) if (3 != t.previousSibling?.nodeType || t.previousSibling.textContent || t.previousSibling.remove(), t.previousSibling && "BR" == t.previousSibling.nodeName) {
                    ...
                    return _.prototype = {
                        ...
                        applySettings(t, i) {
                            ...
                            var s = g({}, y, "mix" == i.mode ? {dropdown: {position: "text"}} : {}),
                        ...
                        onEditTagDone(t, e) {
                            ...
                            this.trigger("edit:beforeUpdate", i, {cloneData: !1}), this.state.editing = !1, delete e.__originalData, delete e.__originalHTML, t && e[this.settings.tagTextProp] ? (t = this.replaceTag(t, e), this.editTagToggleValidity(t, e), this.settings.a11y.focusableTags ? t.focus() : w(t)) : t && this.removeTags(t), this.trigger("edit:updated", i), this.dropdown.hide(), this.settings.keepInvalidTags && this.reCheckInvalidTags()
                        },
                        replaceTag(t, e) {
                        ...
                        normalizeTags(t) {
                            var e = this.settings, i = e.whitelist, s = e.delimiters, a = e.mode, n = e.tagTextProp,
                                o = [], r = !!i && i[0] instanceof Object, l = Array.isArray(t), d = l && t[0].value,
                        ...
                        parseMixTags(t) {
                            ...
                            return d.forEach(((t, e) => T(t, l[e]))), this.update({withoutChangeEvent: !0}), b(d, this.state.hasFocus), t
                        },
